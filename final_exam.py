...
#Mathematically transform data in order to fit the model. Produce a new data frame by applying 
the specified mathematical transformation to each variable in the data
...
#Produce a new data frame of 1st lags of the data 
lagdt = new_df.shift(1)
lagfactor = factor.shift(1)

#Produce a regression model. Produce a data frame of the fitted values from the 5 models.
